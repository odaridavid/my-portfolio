  ...
  return (
    <section className="max-w-6xl mx-auto mt-20 px-4">
      ...
      <p className="text-neutral-400 text-center mb-12 max-w-2xl mx-auto">
        When I’m not debugging apps, I’m behind decks spinning afrobeats, framing cinematic moments through a lens, or editing video like I’m prepping for Sundance.
      </p>
